...
RLAPI void CloseWindowRL(void);                                     // Close window and unload OpenGL context
...
RLAPI void ShowCursorRL(void);                                      // Shows cursor
...
RLAPI void DrawTextRL(const char *text, int posX, int posY, int fontSize, Color color);       // Draw text (using default font)
