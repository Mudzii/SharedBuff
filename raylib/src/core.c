...
void EndDrawing(void)
{
    ...
    if (gifRecording)
    {
        ...
        if (((gifFramesCounter/15)%2) == 1)
        {
            ...
            DrawTextRL("RECORDING", 50, screenHeight - 25, 10, MAROON);
        }
    ...
    while (!WindowShouldClose() && (state != 4))    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            else if (state == 3)
            {
                ...
                DrawTextRL(SubText("raylib", 0, lettersCount), screenWidth/2 - 44, screenHeight/2 + 48, 50, Fade(BLACK, alpha));
            }
